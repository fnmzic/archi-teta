...
| UC.002 | *[Просмотр списка мероприятий](uc/uc.002.md)* |
| UC.003 | *[Просмотр информации о мероприятии](uc/uc.003.md)* |
| UC.004 | *[Редактирование мероприятия](uc/uc.004.md)* |
...
|--------|------------------------------|-------------------------------------------|
| QR.001 | *Адаптивность* | *приложение должно иметь возможность легко адаптироваться к изменяющимся требованиям пользователей* |
| QR.002 | *Масштабируемость* | *приложение должно быть способным обрабатывать большое количество запросов и пользователей без потери производительности* |
| QR.003 | *Совместимость* | *приложение должно работать с другими системами и устройствами* |
| QR.004 | *Функциональность* | *приложение должно предоставлять все необходимые функциональные возможности, чтобы пользователи могли успешно выполнять свои задачи* |
| QR.005 | *Безопасность* | *приложение должно обеспечивать защиту данных пользователей и предотвращать несанкционированный доступ к системе* |
| QR.006 | *Удобство использования* | *приложение должно быть легко понятным и интуитивно понятным* |
| QR.007 | *Поддерживаемость* | *приложение должно быть легко поддерживаемым и обновляемым для технической команды* |
#### Мониторинг атрибутов качества
| ID     | Атрибут качества             |Алгоритм/способ мониторинга                       |
|--------|------------------------------|-------------------------------------------|
| QR.001 | *Адаптивность* | *мониторинг пользовательского опыта* |
| QR.002 | *Масштабируемость* | *использование инструментов автоматического масштабирования* |
| QR.003 | *Совместимость* | *тестирование совместимости с различными операционными системами, браузерами и устройствами* |
| QR.004 | *Функциональность* | *автоматизированные тесты* |
| QR.005 | *Безопасность* | *журналирование событий безопасности* |
| QR.006 | *Удобство использования* | *мониторинг пользовательского опыта* |
| QR.007 | *Поддерживаемость* | *сбор метрик системы, сбор обратной связи от клиентов* |
