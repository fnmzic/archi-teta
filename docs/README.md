...
|--------|---------------------------------------|
| FR.001 | *Система должна обеспечивать создание мероприятий с возможностью задания наименования мероприятия, описания, датами и временем начала и конца, местом проведения* |
...
| FR.003 | *Система должна обеспечивать возможность продажи билетов на мероприятия, настройка цен и типов билетов, учет проданных билетов* |
| FR.004 | *Система должна обеспечивать возможность отправки приглашений на мероприятие, управление списком гостей, учет принятых и отклоненных приглашений* |
| FR.005 | *Система должна обеспечивать возможность назначения технических специалистов для помощи в настройке и запуске оборудования на мероприятии* |
| FR.006 | *Система должна обеспечивать возможность хранения и управления данными участников мероприятий, спикеров, спонсоров, технических специалистов, приглашенных гостей и других данных, связанных с мероприятием* |
| FR.007 | *Система должна обеспечивать возможность общения с участниками мероприятия путем отправки уведомлений, ответов на вопросы* |
